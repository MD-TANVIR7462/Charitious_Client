      ...
      <Marquee>
        {allTestimonial?.map((SigleTestimonial) => (
          <div
            ...
            className=" flex shadow-xl my-6 md:my-12 flex-col w-[92%] max-w-lg p-6 mx-auto divide-y rounded-md dark:divide-gray-300 dark:bg-gray-50 dark:text-gray-800"
          >
            <div className="flex justify-between p-4">
              <div className="flex space-x-4">
                ...
                <div>
                  ...
                  <span className="text-xs dark:text-gray-600 text-[#2f0554]">
              ...
              <div className="flex items-center space-x-2 dark:text-yellow-700">
                ...
                <span className="text-xl font-bold text-[#2f0554]">4.5</span>
              </div>
            </div>
            <div className="p-4 space-y-2 text-sm text-gray-300 dark:text-gray-600 ">
              <p className="">
