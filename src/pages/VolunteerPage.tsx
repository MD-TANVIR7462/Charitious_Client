    ...
    <section className="">
      <div className="container max-w-xl p-6 py-12 mx-auto space-y-24 lg:px-8 lg:max-w-7xl">
        ...
        <div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
          <div>
            <h3 className="text-2xl font-bold tracking-tight text-purple-500 sm:text-3xl ">
            ...
            <div className="mt-12 space-y-12">
              <div className="flex">
                <div className="flex-shrink-0">
                  <div className="flex items-center justify-center w-12 h-12 rounded-md dark:bg-violet-400 text-gray-50">
                    <svg
                ...
                <div className="ml-4">
                  <h4 className="text-lg font-medium leading-6 text-purple-500 ">
                    Secure Transactions
                  </h4>
          ...
          <div aria-hidden="true" className="mt-10 lg:mt-0">
            <img
              src="https://source.unsplash.com/random/361x481/?charity
              "
              alt=""
        ...
        <div>
          <div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
            <div className="lg:col-start-2">
              <h3 className="text-2xl font-bold tracking-tight sm:text-3xl text-purple-500 ">
                Personalized Giving
              </h3>
              <p className="mt-3 text-lg text-white">
                Whether you want to support a specific cause, organization, or
                campaign, our platform allows for personalized giving. You can
                choose where your donations
              </p>
              <div className="mt-12 space-y-12">
                <div className="flex">
                  <div className="flex-shrink-0">
            ...
            <div className="mt-10 lg:mt-0 lg:col-start-1 lg:row-start-1">
              <img
                src="https://source.unsplash.com/random/361x481/?donation
                "
                alt=""
                className="mx-auto rounded-lg shadow-lg dark:bg-gray-500"
              />
